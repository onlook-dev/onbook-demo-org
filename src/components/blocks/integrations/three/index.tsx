...
import { Replit } from '@/components/svgs/replit'
import { MagicUI } from '@/components/svgs/magic-ui'
import { VSCodium } from '@/components/svgs/vs-codium'
import { MediaWiki } from '@/components/svgs/media-wiki'
